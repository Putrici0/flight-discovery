...
class RecommendationControllerTest {
    ...
    void returnsRouteRecommendationsFromMockData() throws Exception {
        ...
        mockMvc.perform(post("/api/recommendations")
                ...
                .andExpect(jsonPath("$.recommendations[0].sunAzimuthDegrees").isNumber())
                .andExpect(jsonPath("$.recommendations[0].sunExposureScore").isNumber())
                .andExpect(jsonPath("$.recommendations[0].sunExposureSummary").exists())
                .andExpect(jsonPath("$.recommendations[0].estimatedTimeHours").isNumber())
                .andExpect(jsonPath("$.recommendations[0].routeDurationCategory").exists())
                ...
                .andExpect(jsonPath("$.recommendations[0].scoreBreakdown.preferenceScore").isNumber())
