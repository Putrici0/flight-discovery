...
public final class MockFlightData {
    ...
    private static final List<VisualWaypoint> VISUAL_WAYPOINTS = List.of(
            new VisualWaypoint("gc-maspalomas-dunes", "Dunas de Maspalomas", 27.7406, -15.5846, List.of("GCLP"), List.of("coast", "island", "panoramic", "short"), 92.0, 180.0, null),
            new VisualWaypoint("gc-puerto-de-mogan", "Puerto de Mogan", 27.8170, -15.7650, List.of("GCLP"), List.of("coast", "village", "island", "short"), 86.0, 225.0, null),
            new VisualWaypoint("gc-agaete", "Agaete", 28.1005, -15.7004, List.of("GCLP"), List.of("coast", "village", "panoramic", "island"), 88.0, 300.0, null),
            ...
            new VisualWaypoint("gc-las-canteras", "Las Canteras", 28.1404, -15.4366, List.of("GCLP"), List.of("coast", "beach", "urban", "island"), 84.0, 350.0, null),
            ...
            new VisualWaypoint("gc-playa-de-amadores", "Playa de Amadores", 27.7919, -15.7240, List.of("GCLP"), List.of("coast", "beach", "short"), 82.0, 215.0, null),
            new VisualWaypoint("gc-arguineguin", "Arguineguin", 27.7589, -15.6816, List.of("GCLP"), List.of("coast", "village", "short"), 79.0, 190.0, null),
            new VisualWaypoint("gc-puerto-rico", "Puerto Rico de Gran Canaria", 27.7894, -15.7104, List.of("GCLP"), List.of("coast", "beach", "urban", "short"), 80.0, 215.0, null),
            ...
            new VisualWaypoint("gc-gui-gui", "Guguy", 27.9408, -15.8128, List.of("GCLP"), List.of("coast", "cliffs", "mountain", "panoramic"), 93.0, 270.0, null),
            new VisualWaypoint("gc-la-aldea", "La Aldea de San Nicolas", 27.9871, -15.7803, List.of("GCLP"), List.of("coast", "village", "ravine", "panoramic"), 86.0, 280.0, null),
            new VisualWaypoint("gc-anden-verde", "Anden Verde", 28.0317, -15.7587, List.of("GCLP"), List.of("coast", "cliffs", "mountain", "panoramic"), 91.0, 290.0, null),
            new VisualWaypoint("gc-mirador-balcon", "Mirador del Balcon", 28.0204, -15.7685, List.of("GCLP"), List.of("coast", "cliffs", "panoramic"), 90.0, 285.0, null),
            new VisualWaypoint("gc-puerto-de-las-nieves", "Puerto de las Nieves", 28.1018, -15.7107, List.of("GCLP"), List.of("coast", "village", "panoramic"), 87.0, 310.0, null),
            new VisualWaypoint("gc-punta-sardina", "Punta de Sardina", 28.1638, -15.7102, List.of("GCLP"), List.of("coast", "lighthouse", "panoramic"), 83.0, 330.0, null),
