...
public final class MockFlightData {
    ...
    private static final List<VisualWaypoint> VISUAL_WAYPOINTS = List.of(
            ...
            new VisualWaypoint("gc-costa-oeste-fuerteventura", "Costa oeste de Fuerteventura", 28.6000, -13.8000, List.of("GCLP"), List.of("coast", "island", "panoramic"), 90.0),
            new VisualWaypoint("gc-isla-de-lobos", "Isla de Lobos", 28.8000, -13.8000, List.of("GCLP"), List.of("coast", "island", "panoramic"), 88.0),
            new VisualWaypoint("gc-canal-oriental-canarias", "Canal oriental de Canarias", 29.0000, -13.8000, List.of("GCLP"), List.of("coast", "island", "panoramic"), 86.0),
